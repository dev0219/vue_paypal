                        ...
                        <div class="card-body">
                            <div class="options" v-if="!selectedRegistrationMethod">
                                <div class="form-group row">
                                    <div class="col-12">
                                        <button type="button" class="btn btn-default btn-block" @click="onGoogleLoginBtnClick()">
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        <button type="button" class="btn btn-default btn-block" @click="onFacebookLoginBtnClick()">
                                            <svg class="socialIcon" width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        <button type="button" class="btn btn-default btn-block" @click="onEmailLoginBtnClick()">
                                            <svg class="socialIcon" width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        <button type="button" class="btn btn-default btn-block" @click="onPhoneLoginBtnClick()">
                            ...
                            <form class="form-horizontal form-simple" @submit="onEmailFormSubmit($event)" v-if="selectedRegistrationMethod === 'email'">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-info btn-lg btn-block" :disabled="form.submitting">
                                        <i class="ft-unlock"></i>
                                        {{ form.submitting ? "Please wait..." : "Login" }}
                                    </button>
                                </div>
                                <div class="form-group">
                                    <p class="text-center">OR</p>
                                </div>
                                <p class="text-center">Choose another <a href="#" @click="onChangeLoginMethodClick($event)">login</a> method</p>
                            </form>
                            <!-- Form for email end -->
                            ...
                            <form class="form-horizontal form-simple" :class="{'d-none' : selectedRegistrationMethod !== 'phone' || confirmationPhoneCodeObject}">
                                ...
                                <fieldset class="form-group position-relative has-icon-left mb-1" v-if="selectedRegistrationMethod === 'phone'">
                                    <input type="phone" class="form-control form-control-lg input-lg" v-model="formData.phone" id="user-phone" placeholder="Your Phone" required>
                                    <div class="form-control-position">
                                        <i class="la la-phone"></i>
                                    </div>
                                </fieldset>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-info btn-lg btn-block" name="loginBtn" id="phoneLoginBtn" :disabled="form.submitting">
                                        <i class="ft-unlock"></i>
                                        {{ form.submitting ? "Please wait..." : "Login" }}
                                    </button>
                                </div>
                    ...
                    <div class="card-footer">
                        <div class="">
                            <p class="float-xl-left text-center m-0"><a href="recover-password.html" class="card-link">Recover
                                    password</a></p>
                            <p class="float-xl-right text-center m-0">New to EnvyLove.io? <router-link to="/register" class="card-link">Sign Up</router-link></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    export default
    {
        ...
        methods : {
            ...
            onEmailFormSubmit(event)
            {
                ...
                firebaseAuth.signInWithEmailAndPassword(this.formData.email, this.formData.password).then(response =>
                {
                    this.form.errorMsg = "";
                ...
                .catch(error =>
                {
                    if (error.code === "auth/user-not-found" || error.code === "auth/wrong-password" || "auth/auth/invalid-email")
                    {
                        this.form.errorMsg = "Email or password is incorrect";
                    }
